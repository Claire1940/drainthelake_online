...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Drain the Lake Wiki',
    description: 'Copyright and intellectual property information for Drain the Lake Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Drain the Lake Wiki',
      description: 'Copyright and intellectual property information for Drain the Lake Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Drain the Lake Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Drain the Lake Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Drain the Lake Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Drain the Lake Developers</strong> - Creators of the Drain the Lake game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Drain the Lake</strong> - Trademark of the game developers</li>
              <li><strong>Drain the Lake Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Drain the Lake Wiki.
            </p>
            ...
            <p>
              ...
              Drain the Lake Wiki<br />
              Email: <a href="mailto:dmca@drainthelake.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@drainthelake.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Drain the Lake Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Drain the Lake Wiki (drainthelake.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@drainthelake.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@drainthelake.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@drainthelake.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@drainthelake.online</a>
            </p>
            <p>
